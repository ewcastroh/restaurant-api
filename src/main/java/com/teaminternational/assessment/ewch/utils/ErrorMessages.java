...
public class ErrorMessages {
    ...
    public static final String AREA_NOT_FOUND_WITH_ID = "Area not found with id: ";
    public static final String AREA_NOT_FOUND_WITH_USERNAME = "Area not found with username: ";
    public static final String ERROR_CREATING_AREA = "Error creating country.";
